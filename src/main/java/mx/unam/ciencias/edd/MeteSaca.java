...
public abstract class MeteSaca<T> {
    ...
    public T saca() {
        ...
        Nodo nuevo = new Nodo(cabeza.elemento);
        if (cabeza == rabo) {
            cabeza = rabo = null;
        } else {
    ...
    public T mira() {
        // Aquí va su código.
        if (cabeza == null) {
            throw new NoSuchElementException("Lista vacia, no podemos mostrar el primer elemento");
        } else {
    ...
    @Override public boolean equals(Object object) {
        ...
        if (cabeza == null && m.cabeza == null) {
            ...
            //Si resultan de longitud diferente 
            if (n != null || o != null) 
                return false;
